...
# r'C:\Users\StavrosKV\Documents\Projects\ProjectsPY\SkroutzProject\Laptops_skroutz'
filename1 = f"skroutz_laptos_{today}.csv"
...
data['Price_EUR'] = data['Price_EUR'].str.replace(
    '.', '').str.replace('από', '', regex=False).str.replace('�', '', regex=False)
...
data_final.columns
final_columns = ['date_added', 'Brand', 'Product', 'Specs', 'Price_EUR', 'Installments_per_month',
...
#    r'C:\Users\StavrosKV\Documents\Projects\ProjectsPY\SkroutzProject\Clean\Laptops_skroutz_clean', filename)
