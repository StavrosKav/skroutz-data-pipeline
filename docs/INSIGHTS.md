...
- Sales-week analysis covers 13–18 July 2026 against a 1 June – 12 July 2026 baseline; "genuine new low" compares each sale price against the product's minimum over 25 May – 12 July 2026. Early-window caveat: only the sale days with a directly comparable previous day enter the depth statistic — in practice that's 2 of the 6 calendar days in the window (13 and 18 July; 14–16 July have no scrape at all, and 17 July's own previous day is missing), covering roughly 6,600–6,800 tracked products each of those two days. The 141-product ≥10%-cut sample is drawn from that pool.
